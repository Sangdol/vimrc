...
" Help
command -narg=1 H vert help <args>
command -narg=1 Hh tab help <args>
...
nnoremap <silent> <Leader>vx :tabnew<CR>:e /usr/local/Cellar/neovim/0.6.0/share/nvim/runtime/filetype.vim
